...
const CategoryLinks = [
  { name: "Añadir Categoria", href: "category-to-add", icon: CogIcon },
  {
      ...
      <div className="min-h-full">
        ...
        <div className="flex flex-1 flex-col lg:pl-64">
          <div className="flex h-16 flex-shrink-0 border-b border-gray-200 bg-white lg:border-none">
            ...
            >
              <span className="sr-only">Abrir la barra lateral</span>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center">
                      <img
                        ...
                        src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cGVyZmlsfGVufDB8fDB8fHww"
                        alt=""
                      />
                      <div>
                        <div className="flex items-center">
