...
export default function Navbar() {
  ...
  const categoriesToDisplay = categories?.categories?.slice(0, 6);
              ...
              <div className="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                >
                  {currentCoupon
                    ...
                    : "No hay venta flash por el momento"}
                </p>
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  ...
                  <Link to="/" className="lg:hidden">
                    <img
                      className="h-12 mt-1 w-auto mr-14"
                      src={logo}
                      alt="logo.orange"
                    />
                  </Link>
                  ...
                  <div className="flex flex-1 items-center justify-end">
                    {user?.userFound?.isAdmin && (
                      <Link
                        to="/admin"
                        className="inline-flex items-center rounded-md border border-transparent bg-red-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 mr-6"
                      >
                        Panel
                      </Link>
                    )}
