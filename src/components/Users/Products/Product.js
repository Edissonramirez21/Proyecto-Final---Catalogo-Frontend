...
const product = {
  ...
  details: [
    ...
    "Fabricado de forma ética y localmente",
    "Pre-lavado y pre-encogido",
...
const policies = [
  {
    ...
    description: "Reciba su pedido en 2 años",
  },
  {
    name: "Recompensas de fidelidad",
    icon: CurrencyDollarIcon,
    description: "No mires otras camisetas",
  },
];
  ...
  const addToCartHandler = () => {
    ...
    if (selectedSize === "") {
      return Swal.fire({
        icon: "error",
        title: "¡Upss!..",
        text: "Seleccione la talla del producto",
      });
    }
    dispatch(
      addOrderToCartaction({
                ...
                <div className="lg:col-span-8 lg:col-start-5 xl:col-span-9 xl:col-start-4 xl:grid xl:grid-cols-3 xl:items-start xl:gap-x-8">
                  <div className="flex items-center xl:col-span-1">
                    ...
                    <p className="ml-3 text-sm text-gray-700">
                      {review.rating}
                      <span className="sr-only">de un total de 5 estrellas</span>
                    </p>
                  </div>
